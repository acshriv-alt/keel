...
Keel changes through its own rules. A change to the framework is a decision
...
- Absolute dates.
- `KEEL.md` template stays under 120 lines. `STATE.md` template under 60.
...
- Dashboards, web UIs, databases. Keel is files in a repo.
